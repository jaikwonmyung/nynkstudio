    ...
    return (
        <div className="min-h-screen bg-white text-zinc-900 pb-20">
            ...
            <main className="max-w-[1600px] mx-auto px-6 mt-8 grid grid-cols-1 lg:grid-cols-12 gap-12">
                ...
                <div className="lg:col-span-4 space-y-8">
                    ...
                    <section className="space-y-3">
                        <textarea
                            ...
                            className="w-full h-40 bg-white border p-4 text-zinc-900 outline-none resize-none transition-colors placeholder:text-zinc-300 text-xs leading-relaxed rounded-none border-zinc-200 focus:border-[#ff0000]"
                        />
                        {/* Consistency Toggle */}
                        <button
              ...
              ${isGenerating ? 'bg-zinc-50 border-zinc-200 cursor-not-allowed' : 'bg-white hover:bg-zinc-50'}`}
                    >
